...
!MESSAGE 
!MESSAGE NMAKE /f "emfres.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/"emfres.exe" $(OUTDIR)/"emfres.bsc"
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"emfres.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"win32.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"emfres.bsc" 
BSC32_SBRS= \
	$(INTDIR)/"win32.sbr"

$(OUTDIR)/"emfres.bsc" : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:windows /INCREMENTAL:no /PDB:$(OUTDIR)/"emfres.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"emfres.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/"win32.obj" \
	$(INTDIR)/"win32.res"

$(OUTDIR)/"emfres.exe" : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"emfres.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"emfres.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"win32.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"emfres.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /INCREMENTAL:yes /PDB:$(OUTDIR)/"emfres.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"emfres.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/"win32.obj" \
	$(INTDIR)/"win32.res"
...
$(INTDIR)/"win32.res" :  $(SOURCE)  $(DEP_WIN32) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
